...
if(name.charAt(0)=='a' || name.charAt(0)=='b' || name.charAt(0)=='c' || name.charAt(0)=='d'){
    console.log('name = '+name+', output: Masuk group pertama');
  }else if(name.charAt(0)=='e' || name.charAt(0)=='f' || name.charAt(0)=='g' || name.charAt(0)=='h'){
    console.log('name = '+name+', output: Masuk group kedua');
  }else
  {
